//                       PMCTestA.cpp                2021-03-15 Agner Fog
//
...
//     stopcounters
//
// � 2000-2021 GNU General Public License v. 3. www.gnu.org/licenses
//////////////////////////////////////////////////////////////////////////////
    ...
    if (MVendor == INTEL)  {
        ...
        if (Family == 6) {
            ...
            default:
                ...
                if (Model >= 0x80 /*??*/) MFamily = INTEL_ICE;    // Ice Lake
            }
        }
    }
...
SCounterDefinition CounterDefinitions[] = {
    ...
    {153, S_ID5,  INTEL_ICE, 0,  7,     0,   0xa1,     0x08, "uop p?"     }, // uops port ?.
